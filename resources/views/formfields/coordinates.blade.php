...
<div id="coordinates-formfield">
    <coordinates
        inline-template
        ref="coordinates"
        api-key="{{ config('admin.googlemaps.key') }}"
        :points='@json($dataTypeContent->getCoordinates() && count($dataTypeContent->getCoordinates()) ? $dataTypeContent->getCoordinates() : [[ 'lat' => config('admin.googlemaps.center.lat'), 'lng' => config('admin.googlemaps.center.lng') ]])'
        ...
        <div>
            <div class="form-group">
                <div class="col-md-5" v-if="showAutocomplete">
                    <label class="control-label">{{ __('admin::generic.find_by_place') }}</label>
                    <input
                        class="form-control"
                        type="text"
                ...
                <div class="col-md-2" v-if="showLatLng">
                    <label class="control-label">{{ __('admin::generic.latitude') }}</label>
                    <input
                        class="form-control"
                        type="number"
                        step="any"
                ...
                <div class="col-md-2" v-if="showLatLng">
                    <label class="control-label">{{ __('admin::generic.longitude') }}</label>
                    <input
                        class="form-control"
                        type="number"
                        step="any"

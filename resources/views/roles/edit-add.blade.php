...
@section('page_title', __('admin::generic.'.(isset($dataTypeContent->id) ? 'edit' : 'add')).' '.$dataType->getTranslatedAttribute('display_name_singular'))
...
@section('page_header')
    <h1 class="page-title">
        ...
        {{ __('admin::generic.'.(isset($dataTypeContent->id) ? 'edit' : 'add')).' '.$dataType->getTranslatedAttribute('display_name_singular') }}
    </h1>
@stop
                    ...
                    <form class="form-edit-add" role="form"
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="permissions checkbox">
                                ...
                                ?>
                                @foreach(Admin::model('Permission')->all()->groupBy('table_name') as $table => $permission)
                                    <li>

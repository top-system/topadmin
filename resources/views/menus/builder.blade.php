    ...
    <script>
        $(document).ready(function () {
            ...
            $('.add_item').click(function() {
                ...
                $m_form.find("input[type=submit]").val('{{ __('admin::generic.add') }}');
            ...
            $('.item_actions').on('click', '.edit', function (e) {
                $m_form.find("input[type=submit]").val('{{ __('admin::generic.update') }}');
            ...
            $('.item_actions').on('click', '.delete', function (e) {
                ...
                $('#delete_form')[0].action = '{{ route('admin.menus.item.destroy', ['menu' => $menu->id, 'id' => '__id']) }}'.replace('__id', id);
            ...
            $('.dd').on('change', function (e) {
                $.post('{{ route('admin.menus.order_item',['menu' => $menu->id]) }}', {

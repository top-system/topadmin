...
<form role="form" action="{{ route('admin.bread.relationship') }}" method="POST">
		...
		<div class="modal-dialog relationship-panel">
		    <div class="model-content">
		        <div class="modal-header">
	                ...
	                <h4 class="modal-title"><i class="admin-heart"></i> {{ \Illuminate\Support\Str::singular(ucfirst($table)) }}
			        ...
			        <div class="row">
			        	...
			        	@if(isset($dataType->id))
				            <div class="col-md-12 relationship_details">
				                ...
				                <span><input type="text" class="form-control" name="relationship_model" placeholder="{{ __('admin::database.relationship.namespace') }}" value="{{ $relationshipDetails->model ?? ''}}"></span>
				            </div>
				            ...
				            <div class="col-md-12 relationship_details_more">
				                <div class="well">
									...
									<p class="relationship_key belongsToShow belongsToManyShow"><strong>{{ __('admin::database.relationship.store_the') }}
                                    ...
                                    <p class="relationship_key hasOneShow hasManyShow"><strong>{{ __('admin::database.relationship.store_the') }}
									...
									<p class="relationship_taggable"><strong>{{ __('admin::database.relationship.allow_tagging') }}:</strong> <br>
										<input type="checkbox" name="relationship_taggable" class="toggleswitch" data-on="{{ __('admin::generic.yes') }}" data-off="{{ __('admin::generic.no') }}">
				                    </p>
				                </div>
							</div>
				        @else

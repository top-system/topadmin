...
@section('page_title', __('admin::generic.viewing').' '.__('admin::generic.bread'))

@section('page_header')
    <h1 class="page-title">
        <i class="admin-bread"></i> {{ __('admin::generic.bread') }}
    </h1>
@stop
                ...
                <table class="table table-striped database-tables">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:right">{{ __('admin::bread.bread_crud_actions') }}</th>
                        </tr>
                    </thead>
                            ...
                            @if($table->dataTypeId)
                                <a href="{{ route('admin.' . $table->slug . '.index') }}"
                                   class="btn btn-warning btn-sm browse_bread" style="margin-right: 0;">
                                    <i class="admin-plus"></i> {{ __('admin::generic.browse') }}
                                </a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="admin-trash"></i>  {!! __('admin::bread.delete_bread_quest', ['table' => '<span id="delete_builder_name"></span>']) !!}</h4>
                </div>
    ...
    <script>
        ...
        $(function () {
            ...
            $('table .actions').on('click', '.delete', function (e) {
                ...
                $('#delete_builder_form')[0].action = '{{ route('admin.bread.delete', ['__id']) }}'.replace('__id', id);

...
@if (isset($dataType->id))
    @section('page_title', __('admin::bread.edit_bread_for_table', ['table' => $dataType->name]))
    @php
    ...
    @endphp
@else
    @section('page_title', __('admin::bread.create_bread_for_table', ['table' => $table]))
@endif
...
@section('page_header')
    <div class="page-title">
        ...
        @if (isset($dataType->id))
            {{ __('admin::bread.edit_bread_for_table', ['table' => $dataType->name]) }}
        @else
            {{ __('admin::bread.create_bread_for_table', ['table' => $table]) }}
        @endif
    </div>
    @php
...
<ol class="breadcrumb hidden-xs">
    ...
    <li class="active">
        <a href="{{ route('admin.bread.index') }}">
            {{ __('admin::generic.bread') }}
        </a>
    </li>
    <li class="active">
        @if(isset($dataType->id))
        <a href="{{ route('admin.bread.edit', $table) }}">
            {{ $display_name }}
        </a>
        @else
        <a href="{{ route('admin.bread.create', $table) }}">
            {{ $display_name }}
        </a>
        @endif
    </li>
    <li>
        {{ isset($dataType->id) ? __('admin::generic.edit') : __('admin::generic.add') }}
    </li>
</ol>
@endsection
    ...
    <div class="page-content container-fluid" id="adminBreadEditAdd">
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="@if(isset($dataType->id)){{ route('admin.bread.update', $dataType->id) }}@else{{ route('admin.bread.store') }}@endif"
                ...
                @endif
                    ...
                    <div class="panel panel-primary panel-bordered">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title panel-icon"><i class="admin-bread"></i> {{ ucfirst($table) }} {{ __('admin::bread.bread_info') }}</h3>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="display_name_singular">{{ __('admin::bread.display_name_singular') }}</label>
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           placeholder="{{ __('admin::bread.display_name_singular') }}"
                                           value="{{ $display_name }}">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="display_name_plural">{{ __('admin::bread.display_name_plural') }}</label>
                                    @if($isModelTranslatable)
                                        @include('admin::multilingual.input-hidden', [
                                            'isModelTranslatable' => true,
                                    ...
                                    <input type="text" class="form-control"
                                           ...
                                           placeholder="{{ __('admin::bread.display_name_plural') }}"
                                           value="{{ $display_name_plural }}">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="slug">{{ __('admin::bread.url_slug') }}</label>
                                    <input type="text" class="form-control" name="slug" placeholder="{{ __('admin::bread.url_slug_ph') }}"
                                           value="{{ $dataType->slug ?? $slug }}">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="icon">{{ __('admin::bread.icon_hint') }} <a
                                                href="{{ route('admin.compass.index') }}#fonts"
                                                target="_blank">{{ __('admin::bread.icon_hint2') }}</a></label>
                                    <input type="text" class="form-control" name="icon"
                                           placeholder="{{ __('admin::bread.icon_class') }}"
                                           value="{{ $dataType->icon ?? '' }}">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="model_name">{{ __('admin::bread.model_name') }}</label>
                                    <span class="admin-question"
                                        aria-hidden="true"
                                        data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{ __('admin::bread.model_name_ph') }}"></span>
                                    <input type="text" class="form-control" name="model_name" placeholder="{{ __('admin::bread.model_class') }}"
                                           value="{{ $dataType->model_name ?? $model_name }}">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="controller">{{ __('admin::bread.controller_name') }}</label>
                                    <span class="admin-question"
                                        aria-hidden="true"
                                        data-toggle="tooltip"
                                        data-placement="right"
                                        title="{{ __('admin::bread.controller_name_hint') }}"></span>
                                    <input type="text" class="form-control" name="controller" placeholder="{{ __('admin::bread.controller_name') }}"
                                           value="{{ $dataType->controller ?? '' }}">
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-6 form-group">
                                    <label for="policy_name">{{ __('admin::bread.policy_name') }}</label>
                                    <span class="admin-question"
                                          aria-hidden="true"
                                          data-toggle="tooltip"
                                          data-placement="right"
                                          title="{{ __('admin::bread.policy_name_ph') }}"></span>
                                    <input type="text" class="form-control" name="policy_name" placeholder="{{ __('admin::bread.policy_class') }}"
                                           value="{{ $dataType->policy_name ?? '' }}">
                                </div>
                                <div class="col-md-3 form-group">
                                    <label for="generate_permissions">{{ __('admin::bread.generate_permissions') }}</label><br>
                                    ...
                                    <input type="checkbox"
                                           ...
                                           class="toggleswitch"
                                           data-on="{{ __('admin::generic.yes') }}"
                                           data-off="{{ __('admin::generic.no') }}"
                                           @if($checked) checked @endif >
                                </div>
                                <div class="col-md-3 form-group">
                                    <label for="server_side">{{ __('admin::bread.server_pagination') }}</label><br>
                            ...
                            <div class="row clearfix">
                                <div class="col-md-3 form-group">
                                    <label for="order_column">{{ __('admin::bread.order_column') }}</label>
                                    <span class="admin-question"
                                          aria-hidden="true"
                                          data-toggle="tooltip"
                                          data-placement="right"
                                          title="{{ __('admin::bread.order_column_ph') }}"></span>
                                    <select name="order_column" class="select2 form-control">
                                        <option value="">-- {{ __('admin::generic.none') }} --</option>
                                ...
                                <div class="col-md-3 form-group">
                                    <label for="order_display_column">{{ __('admin::bread.order_ident_column') }}</label>
                                    <span class="admin-question"
                                          aria-hidden="true"
                                          data-toggle="tooltip"
                                          data-placement="right"
                                          title="{{ __('admin::bread.order_ident_column_ph') }}"></span>
                                ...
                                <div class="col-md-3 form-group">
                                    <label for="order_direction">{{ __('admin::bread.order_direction') }}</label>
                                    <select name="order_direction" class="select2 form-control">
                                        <option value="asc" @if(isset($dataType) && $dataType->order_direction == 'asc') selected @endif>
                                            {{ __('admin::generic.ascending') }}
                                        </option>
                                        <option value="desc" @if(isset($dataType) && $dataType->order_direction == 'desc') selected @endif>
                                            {{ __('admin::generic.descending') }}
                                        </option>
                                    </select>
                                </div>
                                <div class="col-md-3 form-group">
                                    <label for="default_search_key">{{ __('admin::bread.default_search_key') }}</label>
                                    <span class="admin-question"
                                          aria-hidden="true"
                                          data-toggle="tooltip"
                                          data-placement="right"
                                          title="{{ __('admin::bread.default_search_key_ph') }}"></span>
                            ...
                            <div class="row clearfix">
                                @if (isset($scopes) && isset($dataType))
                                    <div class="col-md-3 form-group">
                                        <label for="scope">{{ __('admin::bread.scope') }}</label>
                                ...
                                <div class="col-md-9 form-group">
                                    <label for="description">{{ __('admin::bread.description') }}</label>
                                    <textarea class="form-control"
                                              name="description"
                                              placeholder="{{ __('admin::bread.description') }}"
                    ...
                    <div class="panel panel-primary panel-bordered">
                        <div class="panel-heading">
                            <h3 class="panel-title panel-icon"><i class="admin-window-list"></i> {{ __('admin::bread.edit_rows', ['table' => $table]) }}:</h3>
                            <div class="panel-actions">
                                <a class="panel-action admin-angle-up" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="row fake-table-hd">
                                ...
                                <div class="col-xs-2">{{ __('admin::bread.display_name') }}</div>
                            ...
                            @foreach($fieldOptions as $data)
                                ...
                                @if(isset($dataType->id))
                                    <?php $dataRow = Admin::model('DataRow')->where('data_type_id', '=', $dataType->id)->where('field', '=', $data['field'])->first(); ?>
                                @endif
                                    ...
                                    <div class="col-xs-2">
                                        @if($isModelTranslatable)
                                            @include('admin::multilingual.input-hidden', [
                                                ...
                                                '_field_trans' => $dataRow ? get_field_translations($dataRow, 'display_name') : json_encode([config('admin.multilingual.default') => ucwords(str_replace('_', ' ', $data['field']))]),
                                            ])
                                        @endif
                                        <input type="text" class="form-control"
...
@include('admin::tools.bread.relationship-new-modal')
...
@section('javascript')
    ...
    <script>
        ...
        function populateRowsFromTable(dropdown){
            ...
            $.get('{{ route('admin.database.index') }}/' + tbl, function(data){

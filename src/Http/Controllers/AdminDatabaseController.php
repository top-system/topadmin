...
use TopSystem\TopAdmin\Database\DatabaseUpdater;
use TopSystem\TopAdmin\Database\Schema\Column;
use TopSystem\TopAdmin\Database\Schema\Identifier;
...
use TopSystem\TopAdmin\Events\TableAdded;
use TopSystem\TopAdmin\Events\TableDeleted;
use TopSystem\TopAdmin\Events\TableUpdated;
...
class AdminDatabaseController extends Controller
{
    ...
    public function show($table)
    {
        ...
        $model_name = Admin::model('DataType')->where('name', $table)->pluck('model_name')->first();
        if (isset($model_name)) {

...
use TopSystem\TopAdmin\Events\BreadUpdated;
...
class AdminBreadController extends Controller
{
    public function index()
    {
        ...
        return Admin::view('admin::tools.bread.index')->with(compact('dataTypes', 'tables'));
    }
    ...
    public function create(Request $request, $table)
    {
        ...
        return Admin::view('admin::tools.bread.edit-add', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $data = $res
                ? $this->alertSuccess(__('admin::bread.success_created_bread'))
                : $this->alertError(__('admin::bread.error_creating_bread'));
            if ($res) {
                event(new BreadAdded($dataType, $data));
            }

            return redirect()->route('admin.bread.index')->with($data);
        } catch (Exception $e) {
            return redirect()->route('admin.bread.index')->with($this->alertException($e, 'Saving Failed'));
        }
    }
    ...
    public function edit($table)
    {
        ...
        return Admin::view('admin::tools.bread.edit-add', compact('dataType', 'fieldOptions', 'isModelTranslatable', 'tables', 'dataTypeRelationships', 'scopes'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        /* @var \TopSystem\TopAdmin\Models\DataType $dataType */
        try {
            ...
            $res = $dataType->updateDataType($request->all(), true);
            $data = $res
                ? $this->alertSuccess(__('admin::bread.success_update_bread', ['datatype' => $dataType->name]))
                : $this->alertError(__('admin::bread.error_updating_bread'));
            if ($res) {
    ...
    public function destroy($id)
    {
        ...
        $data = $res
            ? $this->alertSuccess(__('admin::bread.success_remove_bread', ['datatype' => $dataType->name]))
            : $this->alertError(__('admin::bread.error_updating_bread'));
        if ($res) {
    ...
    public function addRelationship(Request $request)
    {
        ...
        try {
            ...
            $className = Admin::modelClass('DataRow');

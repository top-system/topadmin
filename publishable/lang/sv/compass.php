...
return [
    'welcome'           => 'Välkommen till Admin Compass. Alla bra appar behöver in kompass som visar riktningen.
    I denna avdelning hittar du resurser som hjälper dig att bygga din applikation',
    'links' => [
        'title'                 => 'Länkar',
        'documentation'         => 'Dokumentation',
        'voyager_homepage'      => 'Admin Hemsida',
    ],
    'commands' => [
        'title'                 => 'Kommandon',
        'text'                  => 'Kör Artisan Kommandon från Admin.',
    ...
    'resources' => [
        'title'                 => 'Resurser',
        'text'                  => 'Admin resurser som hjälper dig hitta snabbare.',
    ],
    'logs' => [
        'title'                 => 'Loggar',
    ...
    'fonts' => [
        'title'                 => 'Typsnitt',
        'font_class'            => 'Admin Typsnitt Klasser',
        'font_character'        => 'Admin Typsnitt Tecken',
    ],
];

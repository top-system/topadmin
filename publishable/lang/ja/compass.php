...
return [
    'welcome'                => 'Adminコンパスへようこそ。 すべての素晴らしいアプリケーションには正しい方向を示すコンパスが必要です。
        このセクションでは、アプリケーションを構築する際に役立つ多くのリソースと管理タスクを紹介します。',
    'links'         => [
        'title'                 => 'リンク',
        'documentation'         => 'ドキュメント(英語サイト)',
        'voyager_homepage'      => 'Admin ホームページ (英語サイト)',
    ],
    'commands'      => [
        'title'                 => 'コマンド',
        'text'                  => 'AdminからArtisanコマンドを実行します。',
        'clear_output'          => '出力をクリア',
    ...
    'resources'     => [
        'title'                 => 'リソース',
        'text'                  => 'Adminリソースはより素早く探しものをする手助けとなります。',
    ...
    'fonts'         => [
        'title'                 => 'フォント',
        'font_class'            => 'Admin Fonts Class マッピング',
        'font_character'        => 'Admin Fonts Character マッピング',
    ],
];

...
return [
    'welcome'                => 'Добре дошли във Admin Compass. Всяка хубава апликация има нужда от компас да насочва потребителите към правилната посока.

    В тази секция ще намерите много ресурси и административки задачи, които ще ви помогнат да създадете вашата апликация.',
    'links'         => [
        'title'                 => 'Линкове',
        'documentation'         => 'Документация',
        'voyager_homepage'      => 'Начална страница на Admin',
    ],
    'commands'      => [
        'title'                 => 'Команди',
        'text'                  => 'Run Artisan команди от Admin.',
    ...
    'resources'     => [
        'title'                 => 'Ресурси',
        'text'                  => 'Admin ресурси, които ще ви помогнат да намерите всичко по-бързо.',

...
return [
    'welcome'                => 'Bienvenido(a) a Admin Compass. Toda buena aplicación necesita una brújula que guíe en la dirección correcta.
    En esta sección encontrará recursos y tareas administrativas para ayudarle con la construcción de su aplicación.',
    'links'         => [
        'title'                 => 'Enlaces',
        'documentation'         => 'Documentación',
        'voyager_homepage'      => 'Página de inicio de Admin',
    ],
    'commands'      => [
        'title'                 => 'Comandos',
        'text'                  => 'Ejecute comandos Artisan desde Admin.',
    ...
    'resources'     => [
        'title'                 => 'Recursos',
        'text'                  => 'Recursos sobre Admin a la mano.',
    ],
    'logs'          => [
        'title'                 => 'Registros',
    ...
    'fonts'         => [
        'title'                 => 'Fuentes',
        'font_class'            => 'Mapa de clases de Admin Fonts',
        'font_character'        => 'Mapa de caracteres de Admin Fonts',
    ],
];

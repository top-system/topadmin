...
return [
    'welcome'                => 'Բարի գալուստ Admin կողմնացույց. Յուրաքանչյուր լավ հավելվածի պետք է կողմնացույց, որը կմատնանշի նրանց ճիշտ ուղղությամբ։
    ...
    'links'         => [
        ...
        'voyager_homepage'      => 'Admin Գլխավոր էջ',
    ],
    'commands'      => [
        'title'                 => 'Հրամաններ',
        'text'                  => 'Աշխատեցնել Artisan հրամանները Admin-ից։',
    ...
    'resources'     => [
        'title'                 => 'Ռեսուրսներ',
        'text'                  => 'Admin-ի ռեսուրսները օգնում են Ձեզ գտնել ավելի արագ',
    ...
    'fonts'         => [
        'title'                 => 'Տառատեսակներ',
        'font_class'            => 'Admin-ի տառատեսակների դասերի քարտեզագրում',
        'font_character'        => 'Admin-ի տառատեսակների նիշերի քարտեզագրում',
    ],
];

...
return [
    'welcome'                => 'Admin Pusula\'ya hoşgeldiniz. Her iyi uygulama doğru istikamette ilerlemek için bir pusulaya ihtiyaç duyar.
    Bu bölümde uygulamanızı geliştirirken size rehberlik edecek bir çok kaynak ve yönetimsel görev bulacaksınız.',
    'links'         => [
        'title'                 => 'Bağlantılar',
        'documentation'         => 'Dokümantasyon',
        'voyager_homepage'      => 'Admin Anasayfa',
    ],
    'commands'      => [
        'title'                 => 'Komutlar',
        'text'                  => 'Artisan Komutlarını Admin\'dan Çalıştır.',
    ...
    'resources'     => [
        'title'                 => 'Kaynaklar',
        'text'                  => 'Aradığınız şeyleri bulmanızı kolaylaştıracak Admin kaynakları.',
    ...
    'fonts'         => [
        'title'                 => 'İkonlar',
        'font_class'            => 'Admin İkon Class Eşleştirmesi',
        'font_character'        => 'Admin İkon Karakter Eşleştirmesi',
    ],
];

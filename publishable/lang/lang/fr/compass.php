...
return [
    'welcome'                => 'Bienvenue sur Admin Compass. Chaque nouvelle application a besoin d\'une boussole pour se diriger dans la bonne direction.
    ...
    'commands'      => [
        'title'                 => 'Commandes',
        'text'                  => 'Lancer les Commandes artisan depuis Admin.',
    ...
    'resources'     => [
        'title'                 => 'Ressources',
        'text'                  => 'Ressources Admin pour vous aider a trouver certaines choses plus vite.',
    ],
    'logs'          => [
        'title'                 => 'Logs',
    ...
    'fonts'         => [
        ...
        'font_class'            => 'Classe de correspondance à la police Admin',
        'font_character'        => 'Caractère de correspondance à la police Admin',
    ],
];

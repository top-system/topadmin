...
return [
    'welcome'                => 'សូមស្វាគមន៍មកកាន់ Admin Compass ។ កម្មវិធីល្អនីមួយៗត្រូវការត្រីវិស័យដើម្បីចង្អុលពួកវាទៅទិសដៅត្រឹមត្រូវ។
     នៅក្នុងផ្នែកនេះ អ្នកនឹងរកឃើញធនធាន និងកិច្ចការរដ្ឋបាលជាច្រើន ដើម្បីជួយណែនាំអ្នកនៅពេលអ្នកបង្កើតកម្មវិធីរបស់អ្នក។',
    'links'         => [
        'title'                 => 'តំណរភ្ជាប់',
        'documentation'         => 'ឯកសារ',
        'admin_homepage'      => 'គេហទំព័រ Admin',
    ],
    'commands'      => [
        'title'                 => 'ការបញ្ជារ',
        'text'                  => 'ដំណើរការ Command ពី Admin.',
    ...
    'resources'     => [
        'title'                 => 'ធនធាន',
        'text'                  => 'ធនធាន Admin ដើម្បីជួយអ្នកស្វែងយល់បានលឿន',
    ...
    'fonts'         => [
        'title'                 => 'ពុម្ពអក្សរ',
        'font_class'            => 'ពុម្ពអក្សរ Admin',
        'font_character'        => 'តួអក្សរ Admin',
    ],
];

...
return [
    'welcome'                => '
    به قطب نمای admin خوش آمدید! هر اپلیکیشن خوب باید یک قطب نما داشته باشد که کاربران را به جهات صحیح هدایت کند!.
    ...
    'links'         => [
        ...
        'admin_homepage'      => 'صفحه اصلی admin',
    ],
    'commands'      => [
        'title'                 => 'دستورات',
        'text'                  => 'اجرای دستورات Artisan از admin',
    ...
    'resources'     => [
        'title'                 => 'منابع',
        'text'                  => 'منابع Admin برای کمک به شما جهت یافتن سریع تر آنچه به دنبالش هستید',
    ...
    'fonts'         => [
        'title'                 => 'فونت ها',
        'font_class'            => 'نقشه کلاس های فونت Admin',
        'font_character'        => 'نقشه کاراکترهای فونت Admin',
    ],
];
